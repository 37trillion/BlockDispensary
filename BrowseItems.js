<html>
    ...
    <div button click >
        ...
        <p>Thanks for visiting the Browse items for sale page on this page you will see confirmed items from the first hash sector all items if shown are currently for sale for price listed! You can switch between catergories of items for sell on Block Dispensary Blockchain Buy and sell </p>

        <h1 style = align-center>Browse Page Showing Items for sale on the Block Dispensary Blockchain</h1>
        const A = display.Image(if true Image.display);
        function display = Image.data(5secs = display.time) 
        var src-image = live.require(if 5secs return(new.value = image.display))
        src-image call.data void if display.Image{<= 5secs}
        onclick.Item(photo.jpg) == redirect.url.ItemPage
        <h1 src-image = "photo.jpg"> Item one for sale </h1> <h1 src-image = "photo.jpg"> Item two for sale</h1> <h1 src-image = "photo.jpg"> Item three for sale</h1>
        <h1 href="listitem.js> List your item on the Block dispensary Blockchain </h1>
        <h1 src-image = "photo.jpg"> Item four for sale </h1> <h1 src-image = "photo.jpg"> Item five for sale </h1> <h1 src-image = "photo.jpg">Item six for sale</h1>
